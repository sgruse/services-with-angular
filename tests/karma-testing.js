require(__dirname + '/../app/entry.js');
// require(__dirname + '/../app/components/count/countController')
...
describe('It should test soething', () => {
  ...
  beforeEach(angular.mock.inject(function(_CountService_) {
    countService = _CountService_
    // countController = $controller('CountController');

    console.log('COUNT CONTROLLER IN KARMA IS : ' + countService);
  }))
